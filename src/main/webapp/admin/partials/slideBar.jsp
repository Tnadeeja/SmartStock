...
<div class="flex">
    ...
    <aside class="w-64 bg-gray-900 text-gray-300 min-h-screen p-3 space-y-4">
        ...
        <div class="flex items-center gap-3 p-2 bg-dark-blue rounded-lg shadow-sm border border-gray-700">
            <!-- Profile Picture -->
        ...
        <nav class="space-y-2">
            ...
            <!-- Support -->
            <a href="${pageContext.request.contextPath}/admin/supportHandler" class="flex items-center px-3 py-2 rounded-lg <%= currentPage.contains("supportHandler") || currentPage.contains("support") ? "active-tab" : "hover:bg-gray-800 hover:text-primary" %>">
    ...
    <!-- Main content area (previously styled with margin-left: 25%) -->
    <main class="flex-1 p-1 bg-gray-100 min-h-screen">
    </main>
